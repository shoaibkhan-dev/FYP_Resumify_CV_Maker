    ...
    removeArrayItem, 
     ...
     return  <div className="px-5 pt-5">
        ...
        <div className="mt-4 flex flex-col gap-4 mb-3">
           {projectInfo.map((project, index) => (
            ...
            >
              ...
              <div className="col-span-2">
                ...
                <Input 
                     label="Live Demo URL"
                     placeholder="https://yourproject.value"
                     type="url"
           ...
           <button
             type='button'
             className="self-start flex item-center gap-2 px-4 py-2 rounded bg-purple-100 text-purple-800 text-sm font-medium hover:bg-purple-200 cursor-pointer"
             onClick={() =>
                addArrayItem({
                    title: "",
                    description: "",
