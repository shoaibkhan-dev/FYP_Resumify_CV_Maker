...
const LandingPage = () => {
  ...
  return (
    <div className="w-full min-h-full bg-white md:px-10">
       ...
       {/* <img 
        ...
        <div className="flex flex-col md:flex-row items-center">
            <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
                ...
                <button 
                className="bg-black text-sm font-semibold text-white px-8 py-3 rounded-lg hover:bg-gray-800 transition-colors cursor-pounter"
                onClick={handleCTA}
                >
                    Get Started
        ...
        <section className="mt-5 ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition">
                    <h3 className="text-lg font-semibold mb-3 ">Easy Editable</h3>
